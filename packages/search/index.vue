  ...
  <div class="v-search" :style="styles">
    <form action="#" onsubmit="return false;">
      <input type="search"
        ...
        @blur="searchBlurFn"
      />
      <div class="v-search__icon">
        <v-icon name="search" size="14" color="#999"></v-icon>
      </div>
      <div class="v-search__close" v-show="showClose" @click="closeFn">
        <v-icon name="close" size="14" color="#999"></v-icon>
      </div>
    </form>
    <slot></slot>
  </div>
